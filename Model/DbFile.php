 ...
 */
	public $hasAndBelongsToMany = array(
		...
		'ItemSubtype' => array(
			...
			'foreignKey' => 'db_file_id',
			'associationForeignKey' => 'item_subtype_id',
			'unique' => 'keepExisting',
			'conditions' => '',
			'fields' => '',
			'order' => '',
	...
	/*
	 * Before saving a new file add the responsible (logged in) user.
	 */
	public function beforeSave($options = array()) {
		if(empty($this->data['DbFile']['user_id'])) {
			$User = ClassRegistry::init('User');
	
			$this->data['DbFile']['user_id'] = $User->getUserId();
		}
	}
}
