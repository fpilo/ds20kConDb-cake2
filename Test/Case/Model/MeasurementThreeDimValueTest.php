<?php
App::uses('MeasurementThreeDimValue', 'Model');

/**
 * MeasurementThreeDimValue Test Case
 *
 */
class MeasurementThreeDimValueTestCase extends CakeTestCase {
/**
 * Fixtures
 *
 * @var array
 ...
 */
	public function setUp() {
		parent::setUp();
		$this->MeasurementThreeDimValue = ClassRegistry::init('MeasurementThreeDimValue');
	}
 ...
 */
	public function tearDown() {
		unset($this->MeasurementThreeDimValue);
